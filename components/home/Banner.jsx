...
export default function Banner() {
  ...
  return (
    <div className="text-white bg-[url('/assets/images/banner-bg-bottom.webp')] bg-cover pt-28 md:pt-24 relative min-h-[900px] lg:min-h-[650px] xl:min-h-[700px] 2xl:min-h-[1000px] flex items-center justify-center overflow-hidden">
      {/* left side dots */}
      ...
      <section className="flex flex-col-reverse lg:flex-row items-center justify-between main-container relative z-[15]">
        {/* texts and btn */}
        <motion.div
          className="flex justify-center items-center lg:justify-start lg:items-start gap-3 sm:gap-5 flex-1 sm:w-full mt-10 lg:mt-20 lg:max-w-[500px] xl:max-w-[550px] 2xl:max-w-[645px] lg:my-10 xl:my-10 w-[320px] mx-auto lg:mx-0"
        ...
        {/* right side content */}
        <motion.div
          className="flex items-center gap-10 lg:block w-full lg:w-1/2 h-full relative"
        ...
        >
          ...
          <div className="absolute w-full h-2/5 bg-gradient-to-b from-transparent to-black z-[11] bottom-0 left-0" />
        </motion.div>
      </section>
    </div>
  );
